const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'dashboard.toast.duplicated': 'Trip duplicated',
  'dashboard.toast.duplicateError': 'Failed to duplicate trip',
  ...
  'dashboard.confirm.duplicate': 'Duplicate trip "{title}" with its shared members, collaboration, photos, and active files?',
